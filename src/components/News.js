...
export class News extends Component {
  ...
  {
    let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=aae0d9c248904c479273d48fa73cf68d&page=1&pageSize=${this.props.pageSize}`;
  ...
  {
    let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=aae0d9c248904c479273d48fa73cf68d&page=${this.state.page-1}&pageSize=${this.props.pageSize}`;
